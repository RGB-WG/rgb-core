...
use crate::{
    DbcProof, Extension, Genesis, GlobalOrd, OpCommitment, Schema, TransitionBundle, XWitnessId,
    LIB_NAME_RGB,
};

/// Strict types id for the library providing data types for RGB consensus.
pub const LIB_ID_RGB: &str =
    "stl:dU!OV0Il-utBzMra-3saO5RM-H!25$ds-o8hYnve-jiASTe4#carmen-kimono-final";
