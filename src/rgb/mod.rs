...
pub mod prelude {
    ...
    pub use contract::{
        ...
        Contract, ContractId, FieldData, Genesis, HashStrategy, HomomorphStrategy, Metadata, Node,
        NodeId, SealDefinition, StateTypes, Transition, TransitionId, VoidStrategy,
    };
