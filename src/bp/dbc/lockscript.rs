    ...
    MSG: AsRef<[u8]>,
{
    ...
    fn commit_embed(container: Self::Container, msg: &MSG) -> Result<Self, Self::Error> {
        ...
        let lockscript = container
            ...
            .expect(
                "Since we do not return `None` ever, `replace_pubkeys_and_hashes` must not faile",
            );
...
mod test {
    ...
    fn test_no_keys_and_hashes() {
        ...
        let ms = vec![ms_str!("older(921)"), ms_str!("sha256({})", sha_hash)];
