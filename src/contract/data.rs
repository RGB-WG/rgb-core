...
use bitcoin::{secp256k1, OutPoint, Transaction};
...
pub enum Revealed {
    ...
    // TODO #15: Add support for Schnorr's signatures once they will be
    ...
    impl StrictDecode for Revealed {
        fn strict_decode<D: io::Read>(mut d: D) -> Result<Self, Error> {
            ...
            Ok(match format {
                ...
                EncodingTag::Secp256k1Signature => Revealed::Secp256k1ECDSASignature(
                    secp256k1::ecdsa::Signature::strict_decode(&mut d)?,
                ),
                EncodingTag::Curve25519Pubkey => {
                    Revealed::Curve25519Pubkey(ed25519_dalek::PublicKey::strict_decode(&mut d)?)
                }
                EncodingTag::Ed25519Signature => {
                    Revealed::Ed25519Signature(ed25519_dalek::Signature::strict_decode(&mut d)?)
                }
                EncodingTag::TxOutPoint => Revealed::TxOutPoint(OutPoint::strict_decode(&mut d)?),
                EncodingTag::Tx => Revealed::Tx(Transaction::strict_decode(&mut d)?),
                EncodingTag::Psbt => {
                    Revealed::Psbt(PartiallySignedTransaction::strict_decode(&mut d)?)
                }
            })
        }
    }
...
mod test {
    ...
    static TXOUTPOINT_BYTES: [u8; 37] = [
        0x51, 0x53, 0xc6, 0x31, 0x13, 0xed, 0x18, 0x68, 0xfc, 0xa, 0xdf, 0x8e, 0xcd, 0xfd, 0x1f,
        0x4d, 0xd6, 0xe5, 0xe3, 0x85, 0x83, 0xa4, 0x9d, 0xb, 0x14, 0xe7, 0xf8, 0x87, 0xa4, 0xd1,
        0x61, 0x78, 0x21, 0x4, 0x0, 0x0, 0x0,
    ];
    static TX_BYTES: [u8; 194] = [
        ,
    ];
    static PSBT_BYTES: [u8; 556] = [
        ,
    ];
